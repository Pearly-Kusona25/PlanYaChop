...
import com.smartrecipe.middleware.JwtTokenProvider;
import com.smartrecipe.middleware.UserPrincipal;
...
public class AuthService {
    ...
    public AuthResponse authenticateUser(LoginRequest loginRequest, String clientIp) {
        recaptchaService.verify(loginRequest.getRecaptchaToken(), "login", clientIp);
    ...
    public AuthResponse registerUser(RegisterRequest registerRequest, String clientIp) {
        recaptchaService.verify(registerRequest.getRecaptchaToken(), "register", clientIp);
